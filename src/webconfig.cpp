...
std::string setAddonOptions()
{
    ...
    docToValue(analogOptions.joystick_deadzone, doc, "joystickDeadzone");
    ...
    docToValue(analogOptions.joystick_deadzone2, doc, "joystickDeadzone2");
    ...
    docToValue(analogOptions.diagonal_compensation, doc, "diagonalCompensation");
    docToValue(analogOptions.diagonal_compensation2, doc, "diagonalCompensation2");
...
std::string getAddonOptions()
{
    ...
    writeDoc(doc, "joystickDeadzone", analogOptions.joystick_deadzone);
    ...
    writeDoc(doc, "joystickDeadzone2", analogOptions.joystick_deadzone2);
    ...
    writeDoc(doc, "diagonalCompensation", analogOptions.diagonal_compensation);
    writeDoc(doc, "diagonalCompensation2", analogOptions.diagonal_compensation2);
