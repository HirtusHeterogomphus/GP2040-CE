export default {
	...
	'analog-calibration-neutral-prompt': 'Release stick {{stick}} to neutral, then click "OK" to record the neutral position.',
	'analog-calibration-rotation-prompt': 'After clicking "OK", rotate stick {{stick}} around its outer edge for {{seconds}} seconds.',
	'analog-calibration-calibrating': 'Calibrating...',
	'analog-calibration-calibrating-status': 'Calibrating min/max range...',
	'analog-calibration-invalid-range': 'Calibration failed because the measured range did not cross the neutral position on both axes.',
	'analog-calibration-insufficient-range': 'Stick did not travel far enough. Rotate the stick fully around the gate and try again.',
	...
	'analog-calibration-manual-mode-instruction-1': 'Click "Calibrate" button to start rotation calibration',
	'analog-calibration-manual-mode-instruction-2': 'Record neutral first, then rotate the stick around the full outer gate',
	'analog-calibration-manual-mode-instruction-3': 'System will capture X/Y minimum and maximum values from the rotation',
